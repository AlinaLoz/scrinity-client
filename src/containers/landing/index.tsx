  ...
  return (
    <div className={styles.landing}>
          ...
          <div className={styles.logoAndUl}>
            ...
            <ul className={styles.links}>
              <li className="nav-item">
                <a href="#about" className={cn({ [styles.active]: asPath.includes('about') })}>Об SCRINITY</a>
              </li>
              <li className="nav-item">
      ...
      <div className={styles.feedbacks}>
        ...
        <video width="592px" height="373px" className={styles.video} controls autoPlay>
